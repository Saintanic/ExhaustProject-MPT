package com.example.exhaustproject.config;

//import com.example.exhaustproject.security.AuthenticationProvider;
import com.example.exhaustproject.services.PersonDetailsService;
...
//                .antMatchers("/user").hasAnyRole("USER")
                ...
                .antMatchers("/auth/login", "/auth/registration", "/error", "/product", "/product/info/{id}", "/product/search", "/css/**", "/img/**", "/js/**", "/slick/**").permitAll()
